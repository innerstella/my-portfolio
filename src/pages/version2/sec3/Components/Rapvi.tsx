      ...
      <MainContainer>
        ...
        <div className="box">
          ...
          <p className="mt10 text">
            ...
            수 있게 하는 것에 초점을 맞췄습니다. 메뉴 바 진행상황 표시 : 한
            파트에 대한 데이터 입력이 완료되면 좌측 메뉴바에서도 해당 데이터에
            대한 입력 여부를 시각적으로 확인할 수 있게 하였습니다. 입력 방식 :
            csv 데이터를 입력받는 부분에서는 원본 파일을 첨부하는 것은 추후
            데이터 계산 시 형식이 맞지 않아 오류가 날 확률이 높다고
            ...
            개발했습니다. 입력값 시각화 : 다량의 데이터가 입력되는 과정에서
            입력한 값을 확인하고 싶어하는 사용자의 요구 사항이 있었습니다. 이를
            위해 csv 데이터 입력 시 원본 데이터 뿐만 아니라, 해당 데이터로
            그려진 heat map을 확인할 수 있도록 외부 라이브러리를 사용하지 않고
            직접 구현해보았습니다. 또한 Google Maps API를 사용하여 평가하고자
            하는 부지에 대한 정보를 지도 상에서도 확인할 수 있도록 하였습니다.
          </p>
